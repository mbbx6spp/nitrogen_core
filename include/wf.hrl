...
-record(button, {?ELEMENT_BASE(element_button), text="Button", html_encode=true, name, postback, delegate}).
-record(literal, {?ELEMENT_BASE(element_literal), text="", html_encode=true}).
-record(textbox, {?ELEMENT_BASE(element_textbox), text="", maxlength="", html_encode=true, name, next, postback, delegate}).
-record(hidden, {?ELEMENT_BASE(element_hidden), text="", name, html_encode=true}).
-record(textarea, {?ELEMENT_BASE(element_textarea), text="", html_encode=true, name}).
...
-record(dropdown, {?ELEMENT_BASE(element_dropdown), options=[], html_encode=true, postback, delegate, name, value}).
-record(option, { text="", value="", selected=false }).
-record(checkbox, {?ELEMENT_BASE(element_checkbox), text="", html_encode=true, checked=false, value="on", name, postback, delegate}).
